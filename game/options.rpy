...
define config.name = _("MAMBO DE CONDENADOS")
...
define build.name = "MAMBODECONDENADOS"
...
#define config.main_menu_music = "audio/viento.mp3"
define config.main_menu_music = "musica/zamba.mp3" ##### agrregar sonido de viento al mp3
...
define config.save_directory = "MAMBODELOSCONDENADOS-1758055273"
