label capitulo1:    
    ...
    "Nuestro protagonista va al galope por la pampa, sube un cerro por un camino empinado, los pájaros que hasta hace poco cantaban alegremente ahora suenan como gritos de dolor y de repente aparece frente a él, la piedra roja que el viejo le había dicho."

    "Ata y asegura su guitarra a la silla de su fiel caballo y luego pronuncia La Palabra, se abre una cueva en la roca, da un paso dentro y su caballo relincha y sale corriendo hacia el lado contrario."
    ...
    label Las_primeras_pruebas:
        "En el primer pasillo de este laberinto se quita los zapatos, el sombrero y el pañuelo, debe ser así, ya sumido en la oscuridad comienza a escuchar el arpa y pronto siente la presencia del basilisco, menos mal que no se ve, sino lo petrificaría, sigue su siseo, el basilisco lo guía para atravesar este laberinto."
        "Ya en el pasillo recto y angosto comienza a caminar, de repente siente las primeras alimañas, serpientes, iguanas y tarántulas comienzan a trepar por su cuerpo, se queda completamente quieto, de a una van pasando por sus piernas, su pecho, su cabeza, sus hombros y bajan por su espalda siguiendo el camino sin hacerle daño. Todas terminan de pasar y ahora sí, puede avanzar."
        "Entonces aparece ese animal grotezco, un chivo de pelo negro, ojos endemoniados, cuernos tan curvados como un espiral, que bufea en dirección hacía nuestro protagonista, lo rodea sin que se mosquee, pero cuando por fin llega al otro lado, el animal se da vuelta y corre, lo topea y lo arroja a un hoyo."

    jump La_caida

    label La_caida:
        "El hueco es profundo, más que profundo, está cayendo al abismo, ve pasar murciélagos a su lado y sigue cayendo, de repente se desmaya."
        "Despiertas y estás en el fondo, ves sobre ti el abismo que sube en espirales de roca viva, te levantas y no puedes ver más allá delante tuyo, es una profunda oscuridad."
        "¿Qué decides?"
        menu:
    ...
    label Trepar_por_el_abismo_para_salir:
        "Luego de mucho esfuerzo y luchar contra murciélagos que te atacaban débilmente logras llegar hasta el borde del hoyo, estás de vuelta frente a aquel chivo endemoniado, te mira colérico."
        menu:
            "Te enfrentas al chivo":
                jump  Te_enfrentas_al_chivo
            "Intentas esquivar al chivo":
        ...
        label Intentas_esquivar_al_chivo:
            ...
            "Das un paso y el chivo corre tan rápidamente hacia tí que no logras evitarlo, te tira nuevamente por el hueco del que acabas de salir."
            menu:
    ...
    label Dar_un_paso_hacia_la_oscuridad:
        "Escuchas una pequeña explosión y se comienzan a prender, a cada lado, cien antorchas, lográs ver una sala con cortinas magníficas que cubren paredes de roca negra, piso y columnas de mármol que sostienen un techo de tierra y rocas."
        ...
        label Esperar_en_silencio:
            "Se abre un agujero, luego de que se desmoronara una de las paredes y él atraviesa las cortinas, un enorme ser, mitad serpiente, mitad humano, ES EL MANDINGA. Se sienta en su trono y te mira con un gesto entre curioso y vehemente."
        ...
        label DÓNDE_ESTÁ_EL_MANDINGA:
            "De repente escuchas una explosión mucho mayor que la de antes, se abre un agujero en una de las paredes y él atraviesa las cortinas, un enorme ser, mitad serpiente, mitad humano, ES EL MANDINGA. Se sienta en su trono y te mira con un gesto entre curioso y vehemente."
            Mandinga "- ¿Qué desea el que me busca?"
            "Su voz retumba como un trueno en toda la habitación y una vez termina su frase queda resonando un zumbido seseante en el ambiente."
            ...
            label Recular:
                "Te arrepientes, empiezas a balbucear y… despiertas, parece todo haber sido un mal sueño, estás completamente borracho con la cabeza sobre una mesa de la pulpería del Tarta. Una guitarra suena, parece que eso te despertó, el payador empieza a contar una vieja leyenda de estas tierras, la leyenda de La Salamanca."
...
label A_dónde_hay_que_firmar:
    "Aceptás vender tu alma y el Mandinga te dice que aún hay unas pruebas más que debés superar, hace un gesto con la mano y ante ti se abre el suelo, una gran grieta separa la sala al medio, de un lado estás vos, del otro el Mandinga, su trono y sus seguidores."
    "Él saca una enorme cuchilla de su costado y la arroja, queda sobre la grieta formando un puente con el filo hacia arriba."
    ...
    label Pasar_decididamente:
        ...
        label Pasar_cautelosamente:
            "Das un paso sobre el cuchillo y dudas, el filo del cuchillo se hunde en tu pie y no podés frenar la fuerza de la gravedad, empezás a caer sobre ese último paso, tu cuerpo se desbalancea y cae."
