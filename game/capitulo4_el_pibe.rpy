label Capítulo_4_El_pobre_Pibe_Farías:
    ...
    "Investigás el cadaver del joven que había estado tocando en la pulpería."
    ...
    "Tirada un poco más adentro del campo, está la guitarra del pibe, rota, destrozada."

    "Tiene otra nota escrita a mano enganchada entre las cuerdas:"

    "“Para Flavia, mi mamá” dice el frente, la abrís y lees"
    ...
    "Decidís llevar la nota vos mismo y la pasas por debajo de la puerta de La Flavia y volvés a tu casa, arrastrando los piés."
    ...
    label La_peor_noche:
        ...
        if Vida_china:
            ...
            "Te metés, sólo, en tu cama y te quedás dormido"
        ...
        "Das un salto en la cama"
        
        jump Es_hora_de_rendir_cuentas

    label Es_hora_de_rendir_cuentas:
        "... el Mandinga está de pié junto a tu cama."
        ...
        "- No te comportaste como alguien digno de el don que te concedí."
    ...
    label La_muerte_de_la_china:
        ...
        "- El don que te dí te puede llevar lejos, pero recordá que cada hechizo cuenta."
    ...
    label La_Masacre_de_El_Mandinga:
        ...
        "Desde ahí podes ver como sus alimañanas invadieron tu pueblo, ves al basilisco, al chivo negro, a cientos de serpientes, arañas y murciélagos."

        "Todas esas bestias entran y salen de casas y locales matando a todos a su paso."

        "No se salva nadie, ves el cadaver del Tarta, ves a niños ser estrangulados por serpientes, ves a ancianos ser pisoteados hasta la muerte por el chivo."

        if Vida_china:
            "Empezás a llorar y ves como él baja nuevamente y sube con tu china, le araña la espalda con una de sus filosas garras."

            "De la espalda de ella empiezan a salir unas plumas negras y marrones, y poco a poco ves como tu compañera se convierte en una especie de lechuza grotesca."
